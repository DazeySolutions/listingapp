...
public enum ReturnStatusCodeType {
    ...
    /**
     * 
     * 							This value indicates that the return request is pending approval.
     * 						
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the return request was rejected.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return request was successfully opened.
     * 					
     * 
     */
    ...
    /**
     * 
     * 							This value indicates that a return was escalated to an eBay Buyer Protection case and closed.
     * 						
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, and it is pending a response from the buyer.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, and it is pending a response from the seller.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, and it is pending a response from eBay Customer Support.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, but it was closed with a refund issued to the buyer.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, but it was closed with no refund issued to the buyer.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that a return was escalated to an eBay Buyer Protection case, but the reason why is not necessarily known.
     * 					
     * 
     */
