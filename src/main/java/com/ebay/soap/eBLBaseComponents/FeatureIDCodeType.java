...
public enum FeatureIDCodeType {
    ...
    /**
     * 
     * 						This value is deprecated, as Dutch-style auctions are no longer available on
     * 						any eBay sites.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value is deprecated and should no longer be used.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value is deprecated and should no longer be used. To verify if the seller's contact information can be shared with prospective buyers in the listing, use the 'SellerContactDetailsEnabled' enumeration value instead.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value is deprecated and should no longer be used. The Classified Ad Pay-per-lead feature is no longer supported.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value is deprecated and should no longer be used. This enumeration value was needed during eBay's transition from product attributes to Item Specifics. Now that attributes are fully deprecated, and Item Specifics are supported on all sites and categories, this enumeration value is no longer needed.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>Category.ISBNIdentifierEnabled</b> boolean field in the <b>GetCategoryFeatures</b> response will indicate whether or not individual categories on the specified site support the ability of a seller to identify a product through an International Standard Book Number (ISBN) value.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>Category.UPCIdentifierEnabled</b> boolean field in the <b>GetCategoryFeatures</b> response will indicate whether or not individual categories on the specified site support the ability of a seller to identify a product through a Universal Product Code (UPC) value.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>SiteDefaults.FreePicturePackEnabled</b> and <b>Category.FreePicturePackEnabled</b> boolean fields in the <b>GetCategoryFeatures</b> response will indicate whether or not the specified eBay site and individual categories support a free Picture Pack upgrade. The Picture Pack feature is only available for eBay Motors vehicle listings. The Picture Pack feature includes up to 12 supersized photos with the zoom feature enabled for each one.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This enumeration value has been deprecated and should no longer be used.
     * 					
     * 
     */
     ...
     * 						<br/><br/>
     * 						The 'Click and Collect' feature is only available on the eBay UK site (Site ID - 3).
     * 					
     * 
     */
