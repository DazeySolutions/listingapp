 ...
 * 
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/C:/Projects/SDK/Java/V897/build_area/source/wsdl/ebaySvc.wsdl")
public class EBayAPIInterfaceService
    extends Service
{

    private final static URL EBAYAPIINTERFACESERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(EBayAPIInterfaceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = EBayAPIInterfaceService.class.getResource(".");
            url = new URL(baseUrl, "file:/C:/Projects/SDK/Java/V897/build_area/source/wsdl/ebaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/Projects/SDK/Java/V897/build_area/source/wsdl/ebaySvc.wsdl', retrying as a local file");
