...
public enum CancelReasonCodeType {
    ...
    /**
     * 
     * 						This value indicates that the eBay Now order was cancelled due to the fact that the buyer was not at the expected delivery location to receive the order. This value is only applicable to eBay Now orders.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the eBay Now order was cancelled due to the fact that the buyer refused to accept the order. This value is only applicable to eBay Now orders.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the eBay Now order was cancelled due to the fact that the buyer did not successfully schedule the delivery of the order. This value is only applicable to eBay Now orders.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the cancellation of the eBay order was initiated by the buyer.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the eBay Now order was cancelled due to the fact that the eBay Now valet had an issue delivering the order to the buyer. This value is only applicable to eBay Now orders.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the eBay Now order was cancelled due to the fact that no eBay Now valet was available to deliver the order to the buyer. This value is only applicable to eBay Now orders.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the cancellation of the eBay order was initiated by the buyer because the buyer realized that the order will not arrive within the expected delivery time.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the cancellation of the eBay order was initiated by the seller at the request of the buyer, or that there was an issue with the destination address.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						This value indicates that the cancellation of the eBay order was initiated by the seller because the item was out of stock, or due to another reason why the seller was unable to fulfill the order.
     * 					
     * 
     */
